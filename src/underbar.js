(function() {
  ...
  _.last = function(array, n) {
    ...
    if (n === 0) {return [];}
    return n === undefined ? array[length] : array.slice(-n);
  };
  ...
  _.reduce = function(collection, iterator, accumulator) {
    ...
    /*
    var i = 0, key, current = accumulator;
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection, function(stillTrue, item){
      if(iterator === undefined) {
        return item;
      } else if(iterator(item) && stillTrue){
        return true;
      } else {
        return false;
      }
...
*/
  ...
  _.shuffle = function(array) {
    ...
    for (var currentIndex = tempArray.length-1; currentIndex > 0; currentIndex--) {
